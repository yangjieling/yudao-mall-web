    ...
    <div class="panel">
      ...
      <el-form label-width="90px" style="max-width: 480px">
        ...
        <el-form-item label="验证码">
          <div class="code-row">
            <el-input v-model="pwdForm.code" maxlength="6" />
        ...
        <el-form-item label="新密码">
          <el-input v-model="pwdForm.password" type="password" show-password maxlength="20" />
        </el-form-item>
        <el-form-item>
...
async function sendCode() {
  ...
  if (!mobile) return
  // scene 与后端会员修改密码短信场景一致，常见为 3；若环境不同可在管理端核对
